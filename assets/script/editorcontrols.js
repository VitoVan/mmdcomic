...
THREE.EditorControls = function ( object, domElement ) {
	...
	this.pan = function ( distance ) {
		...
		var p = modo.canvas.position();

		modo.canvas.css('left' , p.left - distance.x );
		modo.canvas.css('top' , p.top + distance.y );
	...
	function onMouseMove( event ) {
		...
		var movementX = event.movementX || event.mozMovementX || event.oMovementX || 0;
		var movementY = event.movementY || event.mozMovementY || event.oMovementY || 0;
